...
namespace Elmatgar.persistence.HelperClasses
{
    public class ImageUpload
    {
        public ImageUpload(string uploadPath,string name)
        {
        ...
        public ImageResult RenameUploadFile(HttpPostedFileBase file)
        {
            ...
            //string finalFileName = ((counter).ToString())+ _name;
            //if (System.IO.File.Exists
            //    (HttpContext.Current.Request.MapPath(_uploadPath + finalFileName)))
            //{
