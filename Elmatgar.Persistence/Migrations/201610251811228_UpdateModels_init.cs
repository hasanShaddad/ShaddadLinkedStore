...
{
    //public partial class UpdateModels_init : DbMigration
    //{
    ...
    //            {
    //                Id = c.Int(nullable: false, identity: true),
    //                OlnOrderNo = c.Int(nullable: false),
    //                OlnProdId = c.Int(nullable: false),
    //                OlnLineStatus = c.String(nullable: false, maxLength: 20, unicode: false),
    ...
    //            })
    //            .PrimaryKey(t => t.Id)
    //            .ForeignKey("dbo.Order", t => t.OlnOrderNo)
    //            .ForeignKey("dbo.Products", t => t.OlnProdId)
    //            .Index(t => t.OlnOrderNo)
    //            .Index(t => t.OlnProdId);
    ...
    //            {
    //                Id = c.Int(nullable: false, identity: true),
    //                SoCustNo = c.String(maxLength: 128),
    //                SoOrderStatus = c.String(nullable: false, maxLength: 30, unicode: false),
    ...
    //            })
    //            .PrimaryKey(t => t.Id)
    //            .ForeignKey("dbo.Customers", t => t.SoCustNo)
    ...
    //            {
    //                Id = c.Int(nullable: false, identity: true),
    //                SsSupplierNo = c.Int(nullable: false),
    //                SsStoreName = c.String(nullable: false, maxLength: 100, unicode: false),
    //                SsCountryId = c.Int(nullable: false),
    //                SsCityId = c.Int(nullable: false),
    //                SsAreaId = c.Int(),
    //                CreationDate = c.DateTime(),
    //                LastUpdateDate = c.DateTime(),
    //                CreatedBy = c.String(),
    ...
    //            })
    //            .PrimaryKey(t => t.Id)
    //            .ForeignKey("dbo.Suppliers", t => t.SsSupplierNo)
    //            .ForeignKey("dbo.Zones", t => t.SsAreaId)
    //            .ForeignKey("dbo.Countries", t => t.SsCountryId)
    //            .ForeignKey("dbo.Cities", t => t.SsCityId)
    //            .Index(t => t.SsSupplierNo)
    //            .Index(t => t.SsCountryId)
    //            .Index(t => t.SsCityId)
    //            .Index(t => t.SsAreaId);
    ...
    //            {
    //                Id = c.Int(nullable: false, identity: true),
    //                SSupplierName = c.String(nullable: false, maxLength: 100, unicode: false),
    //                CreationDate = c.DateTime(),
    //                LastUpdateDate = c.DateTime(),
    //                CreatedBy = c.String(),
    //                LastUpdatedBy = c.String(),
    ...
    //            {
    //                Id = c.Int(nullable: false, identity: true),
    //                PopSupplierNo = c.Int(nullable: false),
    //                PopPoNo = c.Int(nullable: false),
    ...
    //            })
    //            .PrimaryKey(t => t.Id)
    //            .ForeignKey("dbo.SupplyOrders", t => t.PopPoNo)
    //            .ForeignKey("dbo.Suppliers", t => t.PopSupplierNo)
    //            .Index(t => t.PopSupplierNo)
    //            .Index(t => t.PopPoNo);
    ...
    //            {
    //                Id = c.Int(nullable: false, identity: true),
    //                PoSupplierNo = c.Int(nullable: false),
    //                PoPoDate = c.DateTime(nullable: false),
    //                CreationDate = c.DateTime(),
    //                LastUpdateDate = c.DateTime(),
    //                CreatedBy = c.String(),
    //                LastUpdatedBy = c.String(),
    //            })
    //            .PrimaryKey(t => t.Id)
    //            .ForeignKey("dbo.Suppliers", t => t.PoSupplierNo)
    //            .Index(t => t.PoSupplierNo);
    ...
    //            {
    //                Id = c.Int(nullable: false, identity: true),
    //                SopCustNo = c.String(maxLength: 128),
    //                SopOrderNo = c.Int(),
    //                Paid = c.Boolean(nullable: false),
    //                CreationDate = c.DateTime(),
    //                LastUpdateDate = c.DateTime(),
    ...
    //            })
    //            .PrimaryKey(t => t.Id)
    //            .ForeignKey("dbo.Customers", t => t.SopCustNo)
    //            .ForeignKey("dbo.Order", t => t.SopOrderNo)
    //            .Index(t => t.SopCustNo)
    //            .Index(t => t.SopOrderNo);
    ...
    //        DropForeignKey("dbo.OrderPayments", "OrderId", "dbo.Order");
    //        DropForeignKey("dbo.OrderDetails", "OrderId", "dbo.Order");
    //        DropForeignKey("dbo.Order", "Dleivery_ID", "dbo.DeliveryMethods");
    ...
    //        DropIndex("dbo.Order", new[] { "Dleivery_ID" });
